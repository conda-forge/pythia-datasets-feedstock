...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pythia-datasets-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13947&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pythia-datasets-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pythia-datasets` can be installed with:

```
conda install pythia-datasets
```

It is possible to list all of the versions of `pythia-datasets` available on your platform with:
